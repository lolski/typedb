...
public class GraqlShellIT {
    ...
    @Test
    public void testStartAndExitShell() {
    ...
    @Test
    public void whenUsingExecuteOptionAndPassingNonGetQueriesWithoutVariables_DoNotPrintWarning() {
    ...
    @Test
    public void testSpecificKeyspace() {
    ...
    @Test
    public void testAutocompleteShellCommand() {
        String result = runShellWithoutErrors("\t");
    ...
    @Test
    public void testAutocompleteFill() {
    ...
    @Test
    public void testRollbackSemicolon() {
        String result = runShellWithoutErrors(
    ...
    @Test
    public void whenErrorIsLarge_UserStillSeesEntireErrorMessage() {
        // We don't show output for this test because the query is really-really-really-really-really-really-really long
        showStdOutAndErr = false;
    ...
    @Test
    public void whenUserMakesAMistake_SubsequentErrorsAreTheSame() {
